...
clauth ships a plugin for [herdr](https://herdr.dev) that does two things: it opens the clauth dashboard in a popup over whatever you were doing, and it labels every herdr pane with the account that pane is spending.
